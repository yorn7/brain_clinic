...
<section class="mv">
  <div class="mv-wrapper">
    <h2 class="mv_text mv-text">
      <picture>
        <source srcset="<?php echo get_template_directory_uri();?>/img/font/mv-text__pc.png" media="(min-width: 768px)" alt="頭痛・めまい・物忘れ あなたの第一の相談相手">
...
<section class="news top-news">
  ...
  <div class="news__inner inner">
    ...
    <div class="btn__wrapper news-btn">
      <a href="<?php echo home_url(); ?>/news" class="btn bgleft"><span>もっと見る</span></a>
    </div>
  </div>
</section>
<!-- news終了 -->
...
<section class="about top-about">
  ...
  <div class="top-items about__inner">
    ...
    <div class="top__content-wrapper">
      ...
      <div class="top__content-items top-about__content">
        ...
        <div class="btn__wrapper top__content-btn">
          <a href="<?php echo home_url(); ?>/about/" class="btn bgleft"><span class="u-mobile">もっと見る</span><span class="u-desktop">クリニックのご紹介</span></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="top-items treatment__inner">
    ...
    <div class="top__content-wrapper">
      <div class="section__title section-title top__items-title">
        ...
        <div class="section-title__text top-treatment__text">
          <h2 class="main__title">診療科目
            <span class="sub__title">Treatment</span>
          </h2>
        </div>
      </div>
      <div class="top__content-items top-treatment__content">
        ...
        <div class="btn__wrapper top__content-btn">
          <a href="<?php echo home_url(); ?>/treatment/" class="btn bgleft"><span>もっと見る</span></a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="contact-content__wrapper">
      ...
      <div class="top__content-items">
        ...
        <div class="btn__wrapper contact-btn">
          <a href="<?php echo home_url(); ?>/contact/" class="btn bgleft"><span class="u-mobile">お問い合わせへ</span><span class="u-desktop">お問い合わせ</span></a>
        </div>
      </div>
    </div>
  </div>
